...
import com.nettactic.hotelbooking.amap.util.TTSController;

/**
 * 按照选定策略导航
 */
public class AMapTTSRouteNaviActivity extends FragmentActivity implements AMapNaviListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_amap_tts_navi);
