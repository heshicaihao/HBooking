 ...
 * 房价详情
 */
public class RoomRateDetailsActivity extends BaseActivity  implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_room_rate_details);
        initView();
        initData();
    ...
    private void initView() {
        ...
        mTitle.setText(MyApplication.getContext().getString(R.string.room_rate_details));
    ...
    private void initData() {
        ...
        String json = AssetsUtils.getJson(this, "room_rate_details_info.txt");
    ...
    private void setEListAdapter(JSONArray data) {
        setMyELVAdapter(this,data,mListView,2);
