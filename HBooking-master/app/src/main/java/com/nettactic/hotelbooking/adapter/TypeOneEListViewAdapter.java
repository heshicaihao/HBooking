 ...
 */
public class TypeOneEListViewAdapter extends BaseExpandableListAdapter {

    private Activity activity;
    private JSONArray data;
    private ExpandableListView eListView;

    public TypeOneEListViewAdapter(Activity activity, JSONArray data, ExpandableListView eListView) {
    ...
    public View getGroupView(final int parentPos, boolean b, View view, final ViewGroup viewGroup) {
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.item_e_listview_parent_type_one, null);
        }
        view.setTag(R.layout.item_e_listview_parent_type_one, parentPos);
        view.setTag(R.layout.item_e_listview_child_type_one, -1);
    ...
    public View getChildView(int parentPos, int childPos, boolean b, View view, ViewGroup viewGroup) {
        if (view == null) {
            LayoutInflater inflater = (LayoutInflater) activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = inflater.inflate(R.layout.item_e_listview_child_type_one, null);
        }
        view.setTag(R.layout.item_e_listview_parent_type_one, parentPos);
        view.setTag(R.layout.item_e_listview_child_type_one, childPos);
