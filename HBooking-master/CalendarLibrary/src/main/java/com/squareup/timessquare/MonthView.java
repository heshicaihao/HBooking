...
//          cellView.setToday(cell.isToday());
                    ...
                    setString(cell, cellView, cellDate);
     ...
     * @param cellDate
     */
    private void setString(MonthCellDescriptor cell, CalendarCellView cellView, String cellDate) {
        SpannableString string = null;
        switch (cell.getRangeState()) {
            case NONE:
                string = getSpannableString(cellDate, "\n  ");
        ...
        TextView day =cellView.getDayOfMonthTextView();
        day.setTextSize(12.0f);
    }
     ...
     * @return
     */
    private SpannableString getSpannableString(String cellDate, String decorator) {
        SpannableString string = new SpannableString(cellDate + decorator);
        string.setSpan(new RelativeSizeSpan(1.33f), 0, cellDate.length(),
